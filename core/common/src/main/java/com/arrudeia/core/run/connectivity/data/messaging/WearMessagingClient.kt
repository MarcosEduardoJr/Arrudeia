package com.arrudeia.core.run.connectivity.data.messaging
...
class WearMessagingClient @Inject constructor (
    context: Context
) : MessagingClient {
    ...
    companion object {
        private const val BASE_PATH_MESSAGING_ACTION = "arrudeia/messaging_action"
    }
}